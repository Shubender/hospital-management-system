...
<div align="center" style="padding: 70px;">
    <table>
        ...
        <tr style="background-color: black" align="center">
            ...
            <td style="padding: 10px; color: white">{{$appoints->data}}</td>
            <td style="padding: 10px; color: white">{{$appoints->message}}</td>
            <td style="padding: 10px; color: white">{{$appoints->status}}</td>
            <td><a class="bt btn-danger" onclick="return confirm('Are you sure?')" href="{{url('cancel_appoint', $appoints->id)}}">Cancel</a></td>
        </tr>
        @endforeach
    </table>
</div>
